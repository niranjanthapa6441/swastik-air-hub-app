...
import 'package:swastik_air_hub/pages/view_booking_detail/main_view_booking_detail.dart';
...
class RouteHelper {
  ...
  static const String viewBookingDetail = '/viewBookingDetail';
  ...
  static String getViewBookingDetail() => '$viewBookingDetail';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: login, page: () => ViewBoookingDetail()),
    GetPage(
